...
import './AddProductCSS/filtercoffeeproductadd.css';  
//////////////////////////////////////////////////////////////////////////////////////////////////////////
////// NOT TO USE 
/////////////////////////////////////////////////////////////////////////////////////////////////////////


function Filtercoffeeproductadd() {
    ...
    const uploadporduct = async() =>{    
      ...
      const responce = await axios.post("http://127.0.0.1:8000/api/filtercoffee" , formData, {
    ...
    <div className="container">
        <div className="row">
          <div className="col-md-a">
            <h5 className="mb-d">Add Product in Filter Coffee </h5> 
...
export default Filtercoffeeproductadd
